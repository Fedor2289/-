...
# ══════════════════════════════════════════════════════════════
#  КОНФИГУРАЦИЯ  — замените перед запуском
# ══════════════════════════════════════════════════════════════
BOT_TOKEN        = "8454209323:AAHoFK834MbxTTdHVqUF4OXLw3Tej4BD7vo"
WEATHER_API_KEY  = "88a9a7cc05358f87f036bb141d8ff164"   # openweathermap.org бесплатно
ADMIN_ID         =   8527998355      # Главный admin — неизменяемый
